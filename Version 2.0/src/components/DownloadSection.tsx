...
export function DownloadSection({ results, parameters }: DownloadSectionProps) {
  ...
  return (
    <div className="bg-white rounded-xl shadow-md p-8">
      <div className="mb-6">
        <h2 className="text-[var(--gray-900)] mb-2">Descarga de Datos y Resultados</h2>
        <p className="text-[var(--gray-600)]">
          Exporte los resultados de las simulaciones en formatos estructurados para análisis posteriores en Python, R, Excel u otras herramientas.
        </p>
      </div>
      ...
      {!hasResults ? (
        <div className="bg-yellow-50 border-2 border-[var(--bolivia-yellow)] rounded-lg p-6 text-center">
          ...
          <p className="text-[var(--gray-700)]">
            No hay resultados disponibles para descargar. Ejecute primero la simulación fiscal.
          </p>
        </div>
      ) : (
        <div className="space-y-6">
          ...
          <div className="border-2 border-[var(--gray-200)] rounded-lg p-6">
            <h4 className="text-[var(--gray-800)] mb-4">Seleccionar Variables para Exportar</h4>
              ...
              {Object.entries(selectedVariables).map(([key, selected]) => (
                ...
                >
                  <input
                    type="checkbox"
                    checked={selected}
                    onChange={() => toggleVariable(key as keyof typeof selectedVariables)}
          ...
          <div className="bg-[var(--gray-50)] border-2 border-[var(--gray-200)] rounded-lg p-6">
            <h4 className="text-[var(--gray-800)] mb-3">Formato de los Datos</h4>
            <div className="space-y-2 text-[var(--gray-700)]">
              <p>
                <strong>CSV/Excel:</strong> Contiene las series temporales 2020-2025 con estadísticos descriptivos (media, percentiles 10, 50 y 90) para cada variable seleccionada.
              </p>
              <p>
                <strong>JSON de Parámetros:</strong> Incluye la configuración completa del modelo (deuda inicial, tasas de interés, crecimiento del PIB, etc.) para reproducibilidad del análisis.
              </p>
              <p className="text-[var(--gray-600)] mt-4">
                <small>
                   <strong>Sugerencia:</strong> Los datos exportados pueden ser procesados en Python (pandas), R (tidyverse), Stata o MATLAB para análisis econométricos avanzados.
                </small>
              </p>
            </div>
          </div>
